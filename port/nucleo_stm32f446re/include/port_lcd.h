...
/* Defines and enums ----------------------------------------------------------*/
/* Defines */
#define LCD_0_ID 0  /*!< Identification number of the LCD system */
#define LCD_0_PORT GPIOC    /*!< Port to which the LCD is connected to*/
#define LCD_0_PIN 0 /*!< Pin to which the LCD is connected to*/

/* Messages -------------------------------------------------------------------*/


/* Instructions ---------------------------------------------------------------*/
#define CLR_DISPLAY 0x01  /*!< Command to clear the display*/
#define RTRN_HOME 0x02  /*!< Command to return the cursor home*/
