...
#define RGB_R_0_GPIO GPIOB    /*!< Red LED GPIO */
#define RGB_R_0_PIN 4    /*!< Red LED Pin */
#define RGB_G_0_GPIO GPIOC    /*!< Green LED GPIO */
#define RGB_G_0_PIN 7    /*!< Green LED Pin */
#define RGB_B_0_GPIO GPIOB   /*!< Blue LED GPIO */
#define RGB_B_0_PIN 5    /*!< Blue LED Pin*/
